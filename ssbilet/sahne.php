...
<body>
  ...
  <section class="container my-5">
    <h2 class="text-center mb-4">Sahne Etkinlikleri</h2>
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          echo '<div class="col">
                    <div class="card">
                      ...
                      <a href="etkinlik_detay_sahne.php?id=' . $row['id'] . '" class="btn btn-primary btn-buy">Satın Al</a>
